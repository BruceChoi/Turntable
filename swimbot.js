...
bot.on('pmmed', function (data)
{
    ...
    else if (text.match(/^\/commands/))
    {
        bot.pm('the commands are  /awesome, ' +
            ' /mom, /chilly, /cheers, /fanratio @, /warnme, /theme, /up?, /djafk, /mytime, /playlist, /position, /afk, /whosafk, /coinflip, /moon, /hello, /escortme, /stopescortme, /fanme, /unfanme, /rules, /beer, /dice, /props, /m, /getTags, ' +
    ...
    {
        bot.pm('/chilly, /moon, /modpm, /warnme, /playlist, /move, /boot, /rules, /djafk, /playminus @, /snagevery, /autosnag, /position, /theme, /mytime, /uptime, /m, /stage @, /botstatus, /djplays, /banstage @, /unbanstage @, ' +
    ...
    {
        bot.pm('/chilly, /moon, /addme, /warnme, /removeme, /djafk, /position, /dive, /getTags, /rules, /awesome, ' + '/theme, /mytime, /uptime, /queue, /djplays, /stopescortme, /escortme, /afk, ' + '/whosafk, /commands, /queuecommands', data.senderid);
    }
